...
function mobile_menu(){
	...
	html += '				<li><a href="/kor/about/global.jsp">개인일정</a></li>';
	html += '				<li><a href="/kor/common/careers.jsp">개인메모</a></li>';
	html += '				<li><a href="/kor/support/contactus.do">지역날씨</a></li>';
	html += '				<li><a href="/kor/support/faq.do">게시판</a></li>';
	html += '			</ul>';
